package com.smartcampus.event.client.impl;
...
import com.smartcampus.event.exception.ServiceUnavailableException;
            ...
            return requestSpec.retrieve()
                    .onStatus(HttpStatusCode::is4xxClientError, (request, response) -> {
                        ...
                        if (statusCode == 404) {
                            ...
                            throw new BadRequestException("Organizer user with ID " + userId + " does not exist");
