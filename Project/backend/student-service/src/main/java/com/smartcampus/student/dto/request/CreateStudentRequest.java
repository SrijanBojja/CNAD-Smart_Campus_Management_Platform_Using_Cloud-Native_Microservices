...
@Schema(description = "Request payload for creating a new student profile")
public class CreateStudentRequest {

    @Schema(description = "Auth user numeric ID", example = "101", requiredMode = Schema.RequiredMode.REQUIRED)
    @NotNull(message = "userId is required")
    private Long userId;

    @Schema(description = "Unique campus student registration number", example = "STU2026001", requiredMode = Schema.RequiredMode.REQUIRED)
    @NotBlank(message = "studentNumber is required")
    @Size(max = 30, message = "studentNumber must not exceed 30 characters")
    ...
    public CreateStudentRequest(Long userId, String studentNumber, String firstName, String lastName,
