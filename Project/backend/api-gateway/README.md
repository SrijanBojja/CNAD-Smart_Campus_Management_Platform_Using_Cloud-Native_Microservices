...
| `NOTIFICATION_SERVICE_URL` | Upstream Notification Service base URL | `http://localhost:8087` |
...
| `notification-service-route` | `/api/v1/notifications/**` | `${NOTIFICATION_SERVICE_URL}` (`http://localhost:8087`) |
