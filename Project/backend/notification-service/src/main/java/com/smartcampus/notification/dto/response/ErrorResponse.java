...
public class ErrorResponse {
    ...
    @Schema(description = "Descriptive error message", example = "Notification not found with ID: 101")
    private final String message;

    @Schema(description = "Request URI path", example = "/api/v1/notifications/101")
